# FitPlanHub - Complete Setup Guide

A comprehensive fitness platform connecting trainers and users with workout plans, progress tracking, and social features.
...
4. Replace the MONGO_URI in your backend `.env` file with your Atlas connection string
...
1. Sign up for a new account (choose either User or Trainer role)
